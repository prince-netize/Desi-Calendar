...
export const EVENTS_BY_YEAR = {
  2023: {
    '2023-01-06': [
      { id: 'purnima-jan', titlePa: 'ਪੂਰਨਮਾਸ਼ੀ', type: 'PURNIMA' },
    ],
    ...
    '2023-02-05': [
      { id: 'purnima-feb', titlePa: 'ਪੂਰਨਮਾਸ਼ੀ', type: 'PURNIMA' },
    ],
    ...
    '2023-03-07': [
      { id: 'purnima-mar', titlePa: 'ਪੂਰਨਮਾਸ਼ੀ', type: 'PURNIMA' },
    ],
    ...
    '2023-04-06': [
      { id: 'purnima-apr', titlePa: 'ਪੂਰਨਮਾਸ਼ੀ', type: 'PURNIMA' },
    ],
    ...
    '2023-05-05': [
      { id: 'purnima-may', titlePa: 'ਪੂਰਨਮਾਸ਼ੀ', type: 'PURNIMA' },
    ],
    ...
    '2023-06-03': [
      { id: 'purnima-jun', titlePa: 'ਪੂਰਨਮਾਸ਼ੀ', type: 'PURNIMA' },
    ],
    ...
    '2023-07-03': [
      { id: 'purnima-jul', titlePa: 'ਪੂਰਨਮਾਸ਼ੀ', type: 'PURNIMA' },
    ],
    ...
    '2023-08-01': [
      { id: 'purnima-aug', titlePa: 'ਪੂਰਨਮਾਸ਼ੀ', type: 'PURNIMA' },
    ],
    ...
    '2023-09-29': [
      { id: 'purnima-sep', titlePa: 'ਪੂਰਨਮਾਸ਼ੀ', type: 'PURNIMA' },
    ],
    ...
    '2023-10-28': [
      { id: 'purnima-oct', titlePa: 'ਪੂਰਨਮਾਸ਼ੀ', type: 'PURNIMA' },
    ],
    ...
    '2023-11-27': [
      { id: 'purnima-nov', titlePa: 'ਪੂਰਨਮਾਸ਼ੀ', type: 'PURNIMA' },
    ],
    '2023-11-26': [{ id: 'maasya-nov', titlePa: 'ਮੱਸਿਆ', type: 'MAASYA' }],

    '2023-12-26': [
      { id: 'purnima-dec', titlePa: 'ਪੂਰਨਮਾਸ਼ੀ', type: 'PURNIMA' },
    ],
  ...
  2026: {
    ...
    '2026-06-15': [
      { id: 'maasya-jun', titlePa: 'ਮੱਸਿਆ', type: 'MAASYA' },
      { id: 'sangrandh-jun', titlePa: 'ਸੰਗਰਾਂਦ', type: 'SANGRANDH' },
    ],
