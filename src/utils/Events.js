...
export const EVENTS_BY_YEAR = {
  2023: {
    ...
    '2023-06-04': [{ id: 'purnima-jun', titlePa: 'ਪੁੰਨਿਆ', type: 'PURNIMA' }],
    '2023-06-15': [
    ...
    '2023-11-26': [{ id: 'purnima-nov', titlePa: 'ਪੁੰਨਿਆ', type: 'PURNIMA' }],
  ...
  2024: {
    ...
    '2024-02-24': [
      { id: 'purnima-feb', titlePa: 'ਪੁੰਨਿਆ', type: 'PURNIMA' },
      { id: 'sangrandh-feb', titlePa: 'ਸੰਗਰਾਂਦ', type: 'SANGRANDH' },
    ],
    '2024-02-09': [{ id: 'maasya-feb', titlePa: 'ਮੱਸਿਆ', type: 'MAASYA' }],

    '2024-03-25': [
      { id: 'purnima-mar', titlePa: 'ਪੁੰਨਿਆ', type: 'PURNIMA' },
      { id: 'sangrandh-mar', titlePa: 'ਸੰਗਰਾਂਦ', type: 'SANGRANDH' },
    ],
    ...
    '2024-06-21': [{ id: 'purnima-jun', titlePa: 'ਪੁੰਨਿਆ', type: 'PURNIMA' }],
    '2024-06-15': [
      { id: 'sangrandh-jun', titlePa: 'ਸੰਗਰਾਂਦ', type: 'SANGRANDH' },
    ],
  ...
  2025: {
    ...
    '2025-08-09': [{ id: 'purnima-aug', titlePa: 'ਪੁੰਨਿਆ', type: 'PURNIMA' }],
    '2025-08-16': [
      { id: 'sangrandh-aug', titlePa: 'ਸੰਗਰਾਂਦ', type: 'SANGRANDH' },
    ],
    ...
    '2025-10-07': [{ id: 'purnima-oct', titlePa: 'ਪੁੰਨਿਆ', type: 'PURNIMA' }],
    '2025-10-17': [
      { id: 'sangrandh-oct', titlePa: 'ਸੰਗਰਾਂਦ', type: 'SANGRANDH' },
    ],
  ...
  2026: {
    ...
    '2026-08-01': [{ id: 'purnima-aug', titlePa: 'ਪੁੰਨਿਆ', type: 'PURNIMA' }],
    ...
    '2026-09-30': [{ id: 'purnima-sep', titlePa: 'ਪੁੰਨਿਆ', type: 'PURNIMA' }],

    '2026-10-14': [{ id: 'maasya-oct', titlePa: 'ਮੱਸਿਆ', type: 'MAASYA' }],
    '2026-10-17': [
      { id: 'sangrandh-oct', titlePa: 'ਸੰਗਰਾਂਦ', type: 'SANGRANDH' },
    ],
    '2026-10-30': [{ id: 'purnima-oct', titlePa: 'ਪੁੰਨਿਆ', type: 'PURNIMA' }],

    '2026-11-13': [{ id: 'maasya-nov', titlePa: 'ਮੱਸਿਆ', type: 'MAASYA' }],
    '2026-11-16': [
      { id: 'sangrandh-nov', titlePa: 'ਸੰਗਰਾਂਦ', type: 'SANGRANDH' },
    ],
    '2026-11-29': [{ id: 'purnima-nov', titlePa: 'ਪੁੰਨਿਆ', type: 'PURNIMA' }],

    '2026-12-13': [{ id: 'maasya-dec', titlePa: 'ਮੱਸਿਆ', type: 'MAASYA' }],
    '2026-12-15': [
      { id: 'sangrandh-dec', titlePa: 'ਸੰਗਰਾਂਦ', type: 'SANGRANDH' },
    ],
    '2026-12-29': [{ id: 'purnima-dec', titlePa: 'ਪੁੰਨਿਆ', type: 'PURNIMA' }],
  },
};
